 ...
 *
 * $Header: /ENTITLEMENT/src/java/com/hp/es/service/contractEntitlement/EsCheckCSDateRange.java 1.9 2004-05-08 04:42:41+02 entitlem Exp $
 *
 ...
 */
public class EsCheckCSDateRange {
    ...
    public static void verifyDate(Date date) throws SifException {
        if ((date!=null) && !date.toString().trim().equalsIgnoreCase("0000-00-00")) {
